...
Karol był odpowiedzialny za pierwotny projekt struktury danych, implementację mechanizmu wytwarzania oraz modyfikacji treningów w sposób intuicyjny dla użytkowników (\ref{subsec:TrainingTab}), a także za funkcjonalność ich importu i eksportu (\ref{sec:Import}). W obszarze przetwarzania sygnałów opracował moduł generujący dudnienia różnicowe (binaural beats w \ref{subsec:SoundsTab}). Ponadto zajął się optymalizacją wydajności poprzez wdrożenie mechanizmu ładowania zasobów z~wyprzedzeniem przed uruchomieniem treningu. W warstwie interfejsu stworzył edytor list odtwarzania plików audio. Wykonał również analizę kontekstu naukowego naszego rozwiązania.
