...
\newcommand{\Hania}[0]{\textcolor{SlateBlue1}{Hania}}
\newcommand{\Jakub}[0]{\textcolor{green}{Jakub}}
\newcommand{\Karol}[0]{\textcolor{Tan1}{Karol}}
\newcommand{\Ola}[0]{\textcolor{Maroon0}{Ola}}
...
\input{rozdzialy/instrukcja_uzytkownika.tex}
