...
>>>>>>> 4a27bfa4665a42a158a2643454904d465ef33789
...
Na stronie widoczna jest lista wszytskich treningów dostępnych dla użytkownika przedstawiona w postaci klikalnych kafelków z~nazwą treningu i~ozdobnym detalem symbolizującym podmuch powietrza. Naciśnięcie kafelka przenosi na stronę szczegółów treningu opisaną dokładnie w sekcji \ref{sec:TrainingPage}. Zawiera ona szczegóły, możliwość edycji, usunięcia, eskportu czy rozpoczęcia treningu. Domyślnie, po zainstalowaniu aplikacji, dostępne są trzy predefiniowane treningi - \textit{Box Breathing}, \textit{4-7-8} oraz \textit{Coherent Method}. Są to popularne treningi oddechowe. W przypadku, gdy użytkownik chce dodać swój trening, może to zrobić klikając ikonę plusa w~białym okręgu z~niebieskim cieniem. Zostanie wtedy przeniesiony na~stronę edycji treningu, która opisana jest w~sekcji \ref{sec:edytor_treningu}. Po dodaniu indywidualnie skonfigurowanego treningu wyświetli się on na~końcu listy, tak jak przedstawiono na rysunku \ref{img/dodany_trening}.
\begin{figure}[H]
    \centering
        \centering
        \setlength{\fboxsep}{0pt}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/Ekran_pobrane.png}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/Komunikat_o_pomyslnym_imporcie.png}}
...
\begin{figure}[H]
    \centering
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/tryb_zaznaczania/Zaznaczone_treningi.png}}
...
\begin{figure}[H]
    \begin{minipage}{0.48\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/tryb_zaznaczania/Komunikat_o_pomyslnym_eksporcie.png}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/tryb_zaznaczania/Komunikat_nie_wybrano_treningow.png}}
...
\begin{figure}[H]
    \centering
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.12]{obrazki/instrukcja/strona_glowna/tryb_zaznaczania/Zapisane_treningi.png}}
...
Na stronie znajduje się również przycisk \textit{Rozpocznij trening}, który przenosi użytkownika na~stronę treningu oddechowego opisaną w sekcji \ref{sec:strona_treningu}, tym samym rozpoczynając ćwiczenie oddechowe odpowiadające szczegółom widocznym na tej stronie.
\begin{figure}[H]
        \centering
        \setlength{\fboxsep}{0pt}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.33]{obrazki/instrukcja/strona_edytora/trening/Zmienianie_kolejnosci_etapow.png}}
...
\begin{figure}[H]
    ...
    \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[scale=0.33]{obrazki/instrukcja/strona_edytora/trening/Zmienianie_kolejnosci_faz.png}}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Interfejs podsekcji \textit{Następna faza oddechu} z wybraną opcją ogólnego dźwięku zmiany fazy (po lewej) oraz z wybranymi osobnymi dźwiękami dla każdej z faz oddechu (po prawej)}
...
\begin{figure}[H]
    ...
    \centering
     \begin{minipage}{0.48\textwidth}
        ...
        \caption{Zatrzymany trening oddechowy}
...
\begin{figure}[H]
    \centering
    \setlength{\fboxsep}{0pt}
    \fbox{\includegraphics[scale=0.14]{obrazki/instrukcja/strona_oddychania/Przerywanie_treningu.png}}
