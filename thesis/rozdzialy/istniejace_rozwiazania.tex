...
\subsection{Funkcjonalności}
Aplikacja składa się z czterech głównych zakładek dostępnych na pasku nawigacyjnym na~dole aplikacji: \textit{Teraz} (ang. Now), \textit{Odkrywaj} (ang. Explore), \textit{Zaplanuj} (ang. Schedule), \textit{Ja} (ang. Me).
